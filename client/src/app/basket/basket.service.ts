...
export class BasketService {
  ...
  getBasket(id: string){
    return this.http.get(this.baseUrl + 'api/basket?id=' + id).pipe(map(
    (basket: IBasket) => {
  ...
  {
    //console.log("the Url = "+this.baseUrl+basket);
    return this.http.post(this.baseUrl + 'api/basket', basket).subscribe((response: IBasket) =>
    {this.basketSource.next(response);this.calculateTotals();}, error => {console.log(error);});
  }
